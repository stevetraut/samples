 ...
 * EJB control communicates with. This bean receives requests for widget inventory, 
...
public class InventoryBean implements javax.ejb.SessionBean {
	...
	/**
	 * Retrieves the list of available items from inventory.
	 * 
	...
	public Item[] listItems() {
		try {
			...
			Object obj = jndiContext.lookup("java:comp/env/ejb/ItemHomeRemote");
