...
set CREDIT_SOURCE=source\com\accounts\creditcheck\*.java

set CREDIT_CLASSES=com\accounts\creditcheck\*.class

javac -classpath %CLASS_PATH% %CREDIT_SOURCE% -d classes

cd classes

jar cvf ..\..\jars\creditcheck_08.jar %CREDIT_CLASSES% META-INF\*.xml
